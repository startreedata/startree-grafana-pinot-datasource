...
describe('Create a Panel with Pinot Query Builder', () => {
  ...
  it('Time series should render when selecting different types of tables', () => {
    ...
    cy.getBySel('select-group-by')
      ...
      .within(() => {
        // Check select list options
        cy.get('input').parent().parent().as('groupBySelect').click();
    ...
    cy.getBySel('select-order-by')
      ...
      .within(() => {
        // Check select list options
        cy.get('input').parent().parent().as('orderBySelect').click();
    ...
    cy.getBySel('select-filters')
      ...
      .within(() => {
        ...
        // Check add filter button
        cy.getBySel('add-filter-btn').as('addFilterBtn');
    ...
    cy.getBySel('select-query-options')
      ...
      .within(() => {
        ...
        // Check add query option button
        cy.getBySel('add-query-option-btn').as('addQueryOptionBtn');
