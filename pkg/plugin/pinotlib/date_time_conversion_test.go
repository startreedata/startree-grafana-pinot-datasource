...
func TestParseTimeGroupExpr(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			want: DateTimeConversion{
				TimeColumn:   "ts",
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 1, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 2, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 5, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 10, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 15, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 30, Unit: TimeUnitMinutes},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 1, Unit: TimeUnitHours},
			},
		}, {
			...
			want: DateTimeConversion{
				...
				InputFormat:  DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				OutputFormat: DateTimeFormat{Size: 1, Unit: TimeUnitMilliseconds, Format: TimeFormatEpoch},
				Granularity:  Granularity{Size: 1, Unit: TimeUnitDays},
			},
		}, {
	...
	for _, tt := range testCases {
		t.Run(tt.expr, func(t *testing.T) {
			got, err := ParseDateTimeConversionExpr(tt.expr)
...
func TestTimeGroup_Equals(t *testing.T) {
	testArgs := []struct {
		expr1, expr2 string
		want         bool
	}{
		{
			...
			expr1: `DATETIMECONVERT("zz", '1:MILLISECONDS:EPOCH', '1:MILLISECONDS:EPOCH', '1:DAYS')`,
			expr2: `FromEpochDaysBucket(ToEpochDaysBucket("ts", 1), 1)`,
			want:  false,
		},
	}
	...
	for _, tt := range testArgs {
		t.Run(tt.expr1+"="+tt.expr2, func(t *testing.T) {
			tg1, err := ParseDateTimeConversionExpr(tt.expr1)
			require.NoError(t, err)
			tg2, err := ParseDateTimeConversionExpr(tt.expr2)
			require.NoError(t, err)
