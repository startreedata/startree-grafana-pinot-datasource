...
func listMapColumnKeys(client *pinot.Client, ctx context.Context, tableName string, columnName string, timeFilterExpr pinot.SqlExpr, filterExprs []pinot.SqlExpr) []string {
